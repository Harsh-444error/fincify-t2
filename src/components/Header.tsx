        ...
        >
          ...
          >
            ...
            <div className="hidden md:block text-sm">
              <div className="font-medium text-white text-sm leading-tight">Harsh </div>
              <div className="text-xs text-gray-400 leading-tight">Harsh Thorat</div>
            </div>
              ...
              {showUserMenu && (
                ...
                >
                  <div className="px-4 py-2 border-b border-gray-700">
                    <div className="font-medium text-white text-sm">Harsh</div>
                    <div className="text-xs text-gray-400">Harsh Thorat</div>
                  </div>
